...
yt.getInfo = async (_0x3c2895, _0x49e43c = {}) => {
  try {
    ...
    console.log("./lib/hanstztech/yt.getInfo()\n", _0x39b819.message);
    return {
      status: false
    };
  }
...
yt.download = async (_0x1ea0cb, _0x5c75ae = {
  ...
  try {
    ...
    let _0x3991fc = _0x150898 + "/MATRIX-XMD " + _0x1ea0cb + "." + _0x35b4d2;
    ...
    console.log("./lib/hanstztech/yt.dowanload()\n", _0x26244e.message);
    return false;
  }
};
async function sendAnimeReaction(_0x5c448a, _0x46face = "punch", _0x50961f = "", _0x426154 = "") {
  try {
    ...
    return await _0x5c448a.error(_0x1b7c90 + "\nERROR AT : /lib/hanstztech.js/sendAnimeReaction()\n\ncommand: " + _0x46face);
  }
}
async function sendGImages(_0x4a189d, _0x4eee7c, _0x205b7c = caption, _0x1caf0d = "") {
  try {
    ...
    return console.log("./lib/hanstztech.js/sendGImages()\n", _0x36d8e7);
  }
}
...
async function randomeFunfacts(_0x1be35e) {
  try {
    ...
    msg.error(_0x1147af);
    console.log("./lib/hanstztech.js/randomeFunfacts()\n", _0x1147af);
  }
}
async function audioEditor(_0x1ef339, _0x567a0f = "bass", _0x730356 = "") {
  ...
  try {
    ...
    return console.log("./lib/hanstztech.js/audioEditor()\n", _0x48606a);
  }
}
async function send(_0x38fbe8, _0x3e1faf, _0x38564b = {
  ...
  try {
    ...
    console.log("./lib/hanstztech.js/send()\n", _0x164757);
  }
}
async function react(_0x460a9b, _0x131f21, _0x1b76d0 = "") {
  try {
    ...
    console.log("./lib/hanstztech.js/react()\n", _0x102c7a);
  }
}
let note = {
  ...
  try {
    ...
    if (_0x2b48e0 && _0x2b48e0.includes(":")) {
      ...
      if (_0x2d4089.toLowerCase() === "richel" || _0x2d4089 === "1") {
        ...
        _0x30713a = 34;
      } else if (_0x2d4089.toLowerCase() === "hanstztech" || _0x2d4089 === "36") {
        _0x30713a = 35;
    ...
    for (const _0x55bb42 of _0x55b13f) {
      ...
      if (_0x1cf682.length >= 1) {
        ...
        if (_0x243ab6 !== -1) {
          ...
          let _0x192321 = /hanstztech|smd|message|chat/gi.test(_0xef10c6);
          if (!_0x4656bb[_0x192321 ? "hanstztech" : _0xef10c6]) {
            _0x4656bb[_0x192321 ? "hanstztech" : _0xef10c6] = [];
          }
        }
        const _0x26ebaf = _0x1cf682.filter(_0x1fa91c => _0x1fa91c !== "type/" + _0xef10c6 && _0x1fa91c !== "");
        _0xef10c6 = /hanstztech|smd|message|chat/gi.test(_0xef10c6) ? "hanstztech" : _0xef10c6;
        if (_0x26ebaf.length > 0) {
          if (_0x22e9cc.includes(_0xef10c6)) {
            ...
            _0x4656bb[/hanstztech/gi.test(_0xef10c6) ? "hanstztech" : "text"].push(_0x26ebaf.join(" "));
          }
        }
      }
      _0xef10c6 = null;
