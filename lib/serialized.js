...
exports.groupsg = async (
  ...
  try {
    ...
    let _0x33935f = hanstztech_grop.decodeJid(hanstztech_grop.user.id);
    let _0xbacc49 = _0x33935f.split("@")[0];
    let hanstztech_bot = {
      ...group_sss,
    };
    hanstztech_bot.chat = hanstztech_bot.jid = hanstztech_bot.from = group_sss.id;
    hanstztech_bot.user = hanstztech_bot.sender = Array.isArray(group_sss.participants)
      ? group_sss.participants[0]
      : "xxx";
    hanstztech_bot.name = await hanstztech_grop.getName(hanstztech_bot.user);
    hanstztech_bot.userNum = hanstztech_bot.senderNum = hanstztech_bot.user.split("@")[0];
    hanstztech_bot.time = getTime("h:mm:ss a");
    hanstztech_bot.date = getTime("dddd, MMMM Do YYYY");
    hanstztech_bot.action = hanstztech_bot.status = group_sss.action;
    hanstztech_bot.isCreator = [
      _0xbacc49,
      ...Astro,
      ...global.sudo?.split(","),
      ...global.devs?.split(","),
      ...
      .includes(hanstztech_bot.user);
    hanstztech_bot.isAstro = [...Astro]
      .map((_0x57d0f3) => _0x57d0f3.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(hanstztech_bot.user);
    hanstztech_bot.fromMe = hanstztech_bot.isAstro
      ? true
      : areJidsSameUser(hanstztech_bot.user, _0x33935f);
    if (hanstztech_bot.action === "remove" && hanstztech_bot.fromMe) {
      return;
    }
    hanstztech_bot.hanstztechBot = [...Astro]
      .map((_0x43191b) => _0x43191b.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(_0x33935f);
    hanstztech_bot.blockJid = [
      "120363023983262391@g.us",
      "120363025246125888@g.us",
      ...global.blockJids?.split(","),
    ].includes(hanstztech_bot.chat);
    hanstztech_bot.isGroup = hanstztech_bot.chat.endsWith("@g.us");
    if (hanstztech_bot.isGroup) {
      hanstztech_bot.metadata = await hanstztech_grop.groupMetadata(hanstztech_bot.chat);
      gcs[hanstztech_bot.chat] = hanstztech_bot.metadata;
      hanstztech_bot.admins = hanstztech_bot.metadata.participants.reduce(
        (_0x3d4871, _0xe2eb9e) =>
          (_0xe2eb9e.admin
            ? _0x3d4871.push({
                id: _0xe2eb9e.id,
      ...
      hanstztech_bot.isAdmin = !!hanstztech_bot.admins.find(
        (_0x859f83) => _0x859f83.id === hanstztech_bot.user
      );
      hanstztech_bot.isBotAdmin = !!hanstztech_bot.admins.find(
        (_0x40eef6) => _0x40eef6.id === _0x33935f
      );
    }
    hanstztech_bot.kick = hanstztech_bot.remove = (_0x48f5af = hanstztech_bot.user) =>
      hanstztech_grop.groupParticipantsUpdate(hanstztech_bot.chat, [_0x48f5af], "remove");
    hanstztech_bot.add = (_0x422af3 = hanstztech_bot.user) =>
      hanstztech_grop.groupParticipantsUpdate(hanstztech_bot.chat, [_0x422af3], "add");
    hanstztech_bot.promote = (_0x3d0644 = hanstztech_bot.user) =>
      hanstztech_grop.groupParticipantsUpdate(hanstztech_bot.chat, [_0x3d0644], "promote");
    hanstztech_bot.demote = (_0x37d435 = hanstztech_bot.user) =>
      hanstztech_grop.groupParticipantsUpdate(hanstztech_bot.chat, [_0x37d435], "demote");
    hanstztech_bot.getpp = async (_0x577c8f = hanstztech_bot.user) => {
      try {
        return await hanstztech_grop.profilePictureUrl(_0x577c8f, "image");
      } catch {
        return "https://telegra.ph/file/93f1e7e8a1d7c4486df9e.jpg";
      }
    };
    hanstztech_bot.sendMessage = async (
      _0x5a0f4b = hanstztech_bot.chat,
      _0x2c78a3 = {},
      _0x11fd9c = {
        quoted: "",
      }
    ) => {
      return await hanstztech_grop.sendMessage(_0x5a0f4b, _0x2c78a3, _0x11fd9c);
    };
    hanstztech_bot.sendUi = async (
      _0x107cb3 = hanstztech_bot.chat,
      _0x15a4e0 = {},
      _0x1e19fa = "",
      _0x3b7229 = false,
      _0x289e17 = false,
      ...
      return await hanstztech_grop.sendUi(
        _0x107cb3,
        _0x15a4e0,
        _0x1e19fa,
        _0x3b7229,
    ...
    hanstztech_bot.error = async (
      ...
      let _0x51c1e7 = _0x471ef2
        ...
        ? hanstztech_bot.chat
        : hanstztech_bot.botNumber;
      let _0x1ac461 =
        "*CMD ERROR*\n```\nUSER: @" +
        hanstztech_bot.user.split("@")[0] +
      ...
      if (
        _0x129b35 &&
        Config.errorChat !== "chat" &&
        hanstztech_bot.chat !== hanstztech_bot.botNumber
      ) {
        await hanstztech_grop.sendMessage(hanstztech_bot.jid, {
          text: _0x129b35,
        });
      }
      console.log(_0xfedfc2 ? _0xfedfc2 : _0x386924);
      try {
        return await hanstztech_grop.sendMessage(
          _0x51c1e7,
          {
            text: _0x1ac461,
            ..._0x32def3,
            mentions: [hanstztech_bot.user],
          },
          {
    ...
    hanstztech_bot.send = async (
      _0x1def38,
      _0x1bb9da = {
        mentions: [hanstztech_bot.user],
      },
      _0xb61629 = "hanstztech",
      _0x919f26 = "",
      _0x3ccfb1 = hanstztech_bot.chat
    ) => {
      _0x3ccfb1 = _0x3ccfb1 ? _0x3ccfb1 : hanstztech_bot.chat;
      switch (_0xb61629.toLowerCase()) {
        ...
        case "react":
          {
            return await hanstztech_grop.sendMessage(_0x3ccfb1, {
              react: {
                text: _0x1def38,
                key: _0x919f26?.key,
              },
        ...
        case "img":
          {
            if (Buffer.isBuffer(_0x1def38)) {
              ...
              return hanstztech_grop.sendMessage(
                _0x3ccfb1,
                {
                  image: {
                    url: _0x1def38,
        ...
        case "pool":
          {
            return await hanstztech_grop.sendMessage(
              ...
              {
                quoted: _0x919f26,
                messageId: hanstztech_grop.messageId(),
              }
            );
          }
          break;
        ...
        case "sticker":
          {
            let { data: _0x2a29f3, mime: _0x48e80f } = await hanstztech_grop.getFile(
              _0x1def38
            );
            if (_0x48e80f == "image/webp") {
              let _0x500c5a = await writeExifWebp(_0x2a29f3, _0x1bb9da);
              await hanstztech_grop.sendMessage(_0x3ccfb1, {
                sticker: {
                  url: _0x500c5a,
                },
                ..._0x1bb9da,
              ...
              await hanstztech_grop.sendImageAsSticker(
                _0x3ccfb1,
                _0x1def38,
                _0x1bb9da
              );
    ...
    hanstztech_bot.sendPoll = async (
      _0x188344,
      _0x4bb725 = ["option 1", "option 2"],
      _0x34efb6 = 1,
      _0xf53aa9 = "",
      _0x2efafc = hanstztech_bot.jid
    ) => {
      return await hanstztech_bot.send(
        _0x188344,
        {
          values: _0x4bb725,
    ...
    hanstztech_bot.checkBot = (_0x31c33b = hanstztech_bot.sender) =>
      [...Astro, _0xbacc49]
        .map((_0x1e666c) => _0x1e666c.replace(/[^0-9]/g) + "@s.whatsapp.net")
        .includes(_0x31c33b);
    hanstztech_bot.botNumber = _0x33935f;
    hanstztech_bot.bot = _0x56741f ? hanstztech_grop : {};
    if (global.AstroOfficial && global.AstroOfficial === "yes") {
      return hanstztech_bot;
    } else {
      return {};
    }
  } catch (_0x26d597) {
...
exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
  ...
  if (_0x32b4a8.key) {
    ...
    _0x2d6cd0.isBot = _0x2d6cd0.isBaileys =
      _0x2d6cd0.id.startsWith("BAE5") || _0x2d6cd0.id.startsWith("hanstztechMD");
