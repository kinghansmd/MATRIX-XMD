...
cmd({
  ...
  try {
    ...
    await _0x4e4351.send(util.format(_0x536aa6), {}, "hanstztech", _0x680da4);
  } catch (_0x2ee8cc) {
...
cmd({
  ...
  try {
    ...
    await _0xbda24.send(util.format(_0x3e1ea8.url), {}, "hanstztech", _0x7d6de1);
  } catch (_0x1a2f02) {
...
smd({
  ...
  try {
    ...
    if (_0x48975a[0]) {
      ...
      _0x5f656f = "*MATRIX-XMD • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ*\n\n*Msg_Id:* " + _0x3079e2.id + "\n*Date:* _" + _0xbcd286 + "_\n*Time:* _" + _0x47ad13 + "_\n\n*Message:* " + _0x5f656f + "\n\n\n" + Config.caption;
...
smd({
  ...
  try {
    if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
      ...
      if (_0x2acf30.reply_text.includes("MATRIX-XMD • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[0].includes("MATRIX-XMD • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[2].includes("Msg_Id")) {
