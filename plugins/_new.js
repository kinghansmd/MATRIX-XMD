let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `HANS AND MATRIX_MD-WHA-BOT\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029VasiOoR3bbUw5aV4qB31\n\n> *©HansTz*`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = `STAR 🌟 FORK AND DEPLOY😁\n\n *REPO:*https://github.com/Mrhanstz/MATRIX-MD\n\n ${Config.botname} *WORKS*`;
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*MATRIX-XMD IS ACTIVE!*";
 ...
 smd({
   ...
   try {
     ...
     if (!_0x11eeb1) {
       return await _0x7587f6.reply("_Need fileName, Example: document hanstztech | caption_");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x587b99) {
       return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/Mrhanstz/MATRIX-MD*");
     }
 ...
 let tmpUrl = "https://files.catbox.moe/perl56.jpeg";
 const secmailData = {};
 smd({
   pattern: "tempmail",
