...
let db = {};
db.get = async () => {
  const _0x39ecdb = "./hanstztech.json";
  try {
...
db.update = async _0x19934a => {
  try {
    const _0x370f4c = "./hanstztech.json";
...
try {
  ...
  smd({
    ...
    use: "[ hanstztech : how can i help you! ]",
  ...
  smd({
    ...
    use: "[ Matrix Md : how can i help you! ]",
    ...
    try {
      ...
      const designs = [
        async () => {
          ...
          const captionText = `MATRIX-XMD \n\n*ʀᴇsᴘᴏɴsᴇ ʀᴀᴛᴇ:* ${pingSeconds} seconds${quoteText}\n\nMATRIX-XMD`;

          return { image: imageBuffer.data, caption: captionText };
        },
        async () => {
          const imageBuffer = await axios.get(
            "https://files.catbox.moe/j1fxdz.jpeg",
            {
              responseType: "arraybuffer",
            }
          );
...
const getContent = async (_0x299ece, _0x10f0d6 = "") => {
  try {
    ...
    console.log("./lib/hanstztech.js/sendWelcome()\n", _0x5cdce0);
  }
};
...
smd({
  ...
  try {
    ...
    if (_0x3d9e60 === "off" || _0x3d9e60 === "disable" || _0x3d9e60 === "deact") {
      ...
      var _0x347b23 = await getContent(_0x50364b, _0x1f0ea7 == "true" || _0x1f0ea7 == "on" ? "Auto Bio By MATRIX-XMD, ⏰Time: @time 🚀@bot" : _0x1f0ea7);
  ...
  if (bio && bio.autobio && typeof bio.autobio === "string" && bio.autobio != "false") {
    if (!isStartAutoBio) {
      ...
      abioJob = cron.schedule("*/1.5 * * * *", async () => {
        try {
          var _0x4b4b3b = "`";
          let _0x34c0a6 = bio.autobio == "true" || bio.autobio == "on" ? "Auto Bio By MATRIX-XMD, ⏰Time: @time 🚀@bot" : bio.autobio;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x35816f || !_0x35816f[0]) {
      return await _0x48b928.reply("*No user has rent 'MATRIX-XMD' yet!*");
    }
    let _0x14cff4 = [...new Set([..._0x35816f.filter(_0x2822d6 => _0x2822d6.user).map(_0x2b342c => _0x2b342c.user)])];
    if (!_0x14cff4 || !_0x14cff4[0]) {
      return await _0x48b928.reply("*There's no user has shared 'MATRIX-XMD'!*");
    }
    let _0x1b2187 = "*[MATRIX-XMD Rent Users]*\n\n";
    let _0x261278 = [];
    let _0xa5efb9 = 1;
...
events.cmd({
  ...
  try {
    ...
    if (!_0x21c25c || !_0x21c25c[0]) {
      return await _0x5d40b9.reply("*No user has rent 'MATRIX-XMD' yet!*");
    }
    ...
    if (_0x5ad48c !== -1) {
      ...
      return await _0x5d40b9.reply("*There's no user who has shared 'MATRIX-XMD'!*");
    }
  } catch (_0x5bad57) {
...
events.cmd({
  ...
  try {
    ...
    if (!_0x41fff7 || !_0x41fff7[0]) {
      return await _0x52616f.reply("*_No user has rent 'MATRIX-XMD' yet!_*\n*_Can't disable cmds for shared users, If the bot is not shared!_*");
    }
...
const Rentt = async (_0x1b984f, _0x8bf7a7, _0x181a7a = "", _0x235024 = {}) => {
  ...
  async function _0x469083() {
    ...
    if (_0x235024.type === "session") {
      var _0xc4323e = ("" + _0x235024[_0x235024.type]).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/, "").replace(/hanstztech;;;/gi, "").replace(/Astro;;;/gi, "").replace(/Astropeda;;;/gi, "").replace(/^hanstztech_\d{2}_\d{2}_\d{2}_\d{2}_/, "").trim();
      var _0x3358ad = {};
  ...
  setTimeout(() => {
    ...
    async function _0x347a1f() {
      ...
      const _0x1a9455 = SuhailMDConnect({
        ...
        browser: _0x235024.type === "pair" ? ["Mac OS", "Safari", "3.1.0"] : ["Share [MATRIX-XMD] by [" + Config.ownername + "]", "Chrome", "1.0.0"],
