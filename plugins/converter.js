...
smd({
  ...
  try {
    ...
    let _0x20f704 = _0x44d3dd[1] && _0x44d3dd[1] !== "" ? _0x44d3dd[1] : "MATRIX-XMD";
...
smd({
  ...
  try {
    let _0x365550 = "┏━━━━━━━━━━━━━━━━━━━━━━━━\n┃\t*🎗️𝙈𝘼𝙏𝙍𝙄𝙓-𝙓𝙈𝘿-𝘽𝙊𝙏_𝙁𝘼𝙉𝘾𝙔_𝙏𝙀𝙓𝙏🎗️* \n┗━━━━━━━━━━━━━━━━━━━━━━━━\n\n " + (_0x3b568a ? "```🔢Reply the number you wants to select``` \n\n" : "```\t\t" + prefix + "fancy MATRIX_XMD-BY-HANSTZ(For all text)\n\t\t" + prefix + "fancy 25 MATRIX_XMD-BY-HANSTZ(For specific text)```\n\n");
    let _0x50c7d9 = parseInt(_0x3b568a);
    if (isNaN(_0x50c7d9)) {
      let _0x4ca942 = _0x3b568a ? _0x3b568a : "MATRIX_XMD-BY-HANSTZ";
...
smd({
  ...
  try {
    ...
    if (!_0xd51ec) {
      return _0x4cfc4e.reply("*_Example : " + prefix + "fliptext MATRIX_XMD-BY-HANSTZ!_*");
    }
...
smd({
  ...
  let hanstztech_mp4 = m.mtype === "videoMessage" ? m : m.reply_message;
  if (!hanstztech_mp4) {
  ...
  let _0x4ab6cb = hanstztech_mp4?.mimetype || "";
  if (hanstztech_mp4?.mtype != "videoMessage" && !/webp/.test(_0x4ab6cb)) {
    return await m.send("*Damn... Reply To An Animated Sticker or Gif *");
  }
  let _0x1c3111 = await m.bot.downloadAndSaveMediaMessage(hanstztech_mp4);
  try {
    try {
...
smd({
  ...
  try {
    ...
    if (_0x2cee76) {
      ...
      return _0x54e3dc.reply("*_Uhh Dear, provide text, ex .ttp 4 hii im MATRIX_XMD-BY-HANSTZ!!_*");
    }
  } catch (_0x72e5d) {
