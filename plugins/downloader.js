...
`;
     ...
     try {
       ...
       for (let i = startIndex - 1; i < endIndex; i++) {
         ...
         if (isSticker) {
           ...
           await message.reply(
             sticker,
             { packname: Config.packname, author: "MATRIX-XMD" },
             "sticker"
           );
         } else {
     ...
     try {
       ...
       if (!_0x1c586e) {
         return await _0x1ae8f8.reply(
           "*Provide Repo Url, _.gitclone https://github.com/Astropeda/MATRIX-XMD_*"
         );
       }
       const _0x5906ab =
 ...
 smd({
   ...
   category: "downloader",
   filename: __filename,
   use: "<Hii,this is MATRIX-XMD>"
 }, async (_0x55aba2, _0x56da6b) => {
   try {
     let _0x204f81 = _0x55aba2.reply_text ? _0x55aba2.reply_text : _0x56da6b;
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am MATRIX-XMD whatsapp bot._*");
     }
     try {
 ...
 smd({
   ...
   try {
     ...
     let _0x4737bb = {
       audio: _0x2ba501,
       fileName: "MATRIX-XMD tiktok Sound" + _0x19c223 + ".m4a",
       mimetype: "audio/mpeg",
       ptt: true,
 ...
 smd(
   ...
   async (m, url) => {
     try {
       ...
       const caption = `『 *MATRIX-XMD • MEDIAFIRE DOWNLOADER* 』\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
 ...
 smd({
   ...
   try {
     ...
     try {
       ...
       let _0x4b47c3 = "./temp/MATRIX-XMD " + _0x1d542b[1] + ".mp3";
     ...
     let _0x300d1a = {
       ...
       mimetype: "audio/mpeg",
       fileName: "MATRIX-XMD--" + _0x1d542b[1] + ".mp3",
       caption: Config.caption,
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     if (_0x5b8ee5[0].includes("MATRIX-XMD • SONG DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("MATRIX-XMD • YOUTUBE DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("MATRIX-XMD • APK DOWNLOAD LIST")) {
