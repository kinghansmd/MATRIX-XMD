...
cmd(
  ...
  async (_0x4e4351) => {
    try {
      ...
      await _0x4e4351.send(util.format(_0x536aa6), {}, "HansTz", _0x680da4);
    } catch (_0x2ee8cc) {
...
cmd(
  ...
  async (_0xbda24) => {
    try {
      ...
      await _0xbda24.send(util.format(_0x3e1ea8.url), {}, "HansTz", _0x7d6de1);
    } catch (_0x1a2f02) {
  ...
  async (_0x45da98) => {
    try {
      let { data: _0x44f98c } = await axios.get(
        "https://api.github.com/repos/Mrhanstz/MATRIX-MD"
      );
      let _0x1c73f9 = (
        "\nMATRIX-XMD A simple Mutil Device WhatsApp Bot Created and Managed by HansTz*" +
        Config.ownername +
        "*. 👑\n\n  *❲☆❳ Stars:* " +
        ...
        "\n  *❲☆❳ Repo:* _https://github.com/Mrhanstz/MATRIX-MD_\n  *❲❒❳ Scan:* _" +
        scan +
        "_\n" +
        (Config.caption ? "\n\n" + Config.caption : "")
      ).trim();
  ...
  async (_0x2acf30) => {
    try {
      if (
        ...
        if (
          _0x2acf30.reply_text.includes("ᴍᴀᴛʀɪx-xᴍᴅ • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
          _0x2dfb59[0].includes("ᴍᴀᴛʀɪx-xᴍᴅ • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
          ...
          try {
            if (_0x2ecd2a) {
              ...
              if (_0x13a11c.toLowerCase().startsWith("reply")) {
                ...
                let _0x3f6b59 =
                  "*ᴍᴀᴛʀɪx-xᴍᴅ • ʏᴏᴜʀ ᴀɴᴏɴʏ-ᴍsɢ ʀᴇᴘʟʏ*\n\n*_From @" +
