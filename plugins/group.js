const {
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x1d2bb7) {
       return await _0x19564c.reply("*Provide Me Country Code. Example: .kik 255*");
     }
     ...
     if (_0x3f4d10 == 0) {
       return await _0x19564c.reply("*_There Is No User Found With " + _0x35a368 + " Country Code_*");
     } else {
 ...
 cmd({
   ...
   try {
     ...
     await _0x324f8b.send("*_@" + _0x8f9e68.split("@")[0] + " is now an admin!_*", {
       mentions: [_0x8f9e68]
     });
   } catch (_0x39a11b) {
 ...
 cmd({
   ...
   try {
     ...
     await _0x5e533c.send("*This idiot, @" + _0x4e844a.split("@")[0] + " Kicked Succesfully!*", {
       mentions: [_0x4e844a]
     });
   } catch (_0x14d7b9) {
 ...
 cmd({
   ...
   try {
     ...
     let _0x552932 = "*--‼️" + tlang().title + " Broadcast‼️--*\n\n *🎗️Message:* " + _0x5d14a3;
     let _0x305de9 = {
       forwardingScore: 999,
       isForwarded: true,
       externalAdReply: {
