      ...
      if (_0x5305a4 && _0x39d1ac.isGroup && !_0x39d1ac.isAdmin && !_0x3447c7 && _0x39d1ac.mtype !== "reactionMessage" && _0x5305a4.botenable == "true") {
        ...
        if (_0x5305a4.antilink && _0x5305a4.antilink !== "false" && AstroOfficial === "yes") {
          ...
          if (_0x2856dd.some(_0x3787e7 => _0x482cec.includes(_0x3787e7))) {
            if (!_0x39d1ac.isBotAdmin) {
              let _0x46235f = " *[MATRIX-XMD LINK DETECTED]*\nUser Fuck you 🖕🖕🖕 @" + _0x39d1ac.sender.split('@')[0x0] + " detected sending a link.\nPromote " + Config.botname + " as admin to " + (_0x5305a4.antilink === "kick" ? "kick \nlink senders." : "delete \nlinks from this Chat") + " \n";
              ...
              if (_0x5305a4.antilink === "delete") {
                ...
                if (_0x5305a4.antilink === 'warn' || _0x5305a4.antilink === "true") {
                  ...
                  var _0x5b1bba = _0x51e325.status ? "*_[MATRIX-XMD LINK DETECTED] Hey 🖕🖕 @" + _0x39d1ac.senderNum + "fuck you and warning!!_*\n*_links not allowed in current group!_*" : "*_[MATRIX-XMD LINK DETECTED]!_*";
    ...
    try {
      ...
      if (_0x180c43 === "true" && !_0x22254d && !_0x39d1ac.isBot && _0x39d1ac.text) {
        ...
        if (_0x5d0149 && _0x5d0149.cnt) {
          _0x39d1ac.send(_0x5d0149.cnt, {}, "MATRIX-XMD", _0x39d1ac);
        } else {
          '';
        }
      }
