    ...
    try {
      ...
      if (!_0x4a3f1c) {
        ...
        if (_0x3dc11c.antitag === "false") {
          ...
          await _0x27399d.send("*_Anti_tag Disabled!_*");
        }
      } else if (
        ...
        if (_0x3dc11c.antitag === "true") {
          await _0x27399d.send(
            "*_Anti_tag already enabled in current!!_*"
          );
        } else {
          await groupdb.updateOne(
            {
          ...
          await _0x27399d.send(
            "*_Anti_tag enabled!_*\n*_Now future will act against tagall_*"
          );
        }
      } else {
        await _0x27399d.send(
  ...
  async (_0x25c82f, _0x4ae2c7, { smd: _0x23c42c }) => {
    try {
      ...
      if (!_0x520158) {
        ...
        return await _0x25c82f.send(
          "*_Anti_Link now set to kick link senders!_*"
        );
        ...
        return await _0x25c82f.send(
          "*_Anti_Link now set to delete links from chat!_*"
        );
        ...
        if (
          ...
          if (_0x50265a && _0x39f91d.isBotAdmin) {
            ...
            await _0x39f91d.reply(
              "*_[MATRIX-XMD DETECTED TAG] Oi Man @" +
                _0x39f91d.senderNum +
                "Acha Ujinga Na Hizo Tag Zako warning!!_*\n*_Tagging all members is not allowed!_*",
              {
            ...
            await _0x39f91d.reply(
              "*_[MATRIX-XMD DETECTED TAG] Can't do anything, without getting admin role!_*",
              {
                mentions: [_0x39f91d.sender],
              }
            );
            ...
            if (_0x37bc15.some((_0x81b040) => _0x5cbc1d.includes(_0x81b040))) {
              if (!_0x39f91d.isBotAdmin) {
                ...
                var _0x3c86e4 = _0xea5278.status
                  ? "*_[MATRIX-XMD DETECTED LINK] Fuck You And your Link 🖕😅🖕 @" +
                    _0x39f91d.senderNum +
                    " warning!!_*\n*_links not allowed here!!_*"
                  : "*_[MATRIX-XMD DETECTED LINK]!_*";
                await _0x39f91d.reply(_0x3c86e4, {
                  mentions: [_0x39f91d.sender],
                });
                await _0x39f91d.delete();
              } else if (_0x273393.antilink === "kick") {
                await _0x39f91d.send("*_MATRIX-XMD DETECTED Link!!_*");
                try {
                  await _0x39f91d.delete();
                  sleep(1500);
                  await _0x39f91d.bot.groupParticipantsUpdate(
                  ...
                  await _0x39f91d.send("*MATRIX-XMD DETECTED Link*\n" + tlang().botAdmin);
                }
              }
            }
          }
          ...
          if (!_0x2298c9 && _0x5e94de && _0x520e96.test(_0x1ae0c5)) {
            ...
            try {
              ...
              if (_0x219875.status === "warn") {
                ...
                if (_0xea5278.status) {
                  _0x3dc4df = "\n*Stop using bad words idiot!!*\n";
                }
              }
              if (_0x39f91d.isBotAdmin) {
                await _0x39f91d.send(
                  "*[MATRIX-XMD DETECTED BAD WORD] Hey @" +
                    _0x39f91d.senderNum +
                    "* " +
                    _0x3dc4df +
                ...
                await _0x39f91d.reply(
                  "*_[MATRIX-XMD DETECTED BAD WORD] provide admin to take action!_*",
                  {
                    mentions: [_0x39f91d.sender],
                  }
                );
