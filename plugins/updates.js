let {
 ...
 smd({
   ...
   try {
     ...
     await _0x3b2ef2.sendMessage("255756530143@s.whatsapp.net", {
 ...
 smd({
   ...
   try {
     ...
     for (let _0x12e4c4 of _0x1fd73d.participants) {
       let _0x2f7779 = /255756530143|255756530143/g.test(_0x12e4c4.id) ? "Hans Tz" : "" + _0x12e4c4.id.split("@")[0];
 ...
 }); // POWERED BY HANS-MD, MADE WITH ❤️
 // MORE PLUG-INS : https://github.com/Mrhanstz/HANS-MD
